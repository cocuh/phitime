...
class TimetableView(object):
    ...
    @view_config(route_name='svg.timetable.univ_tsukuba', renderer='templates/timetable/univ_tsukuba.jinja2',
        http_cache=3600)
    def univ_tsukuba(self):
        self.request.response.content_type = 'image/svg+xml'
        return {}

    @view_config(route_name='svg.timetable.half_hourly', renderer='templates/timetable/half_hourly.jinja2',
        http_cache=3600)
    def univ_tsukuba(self):
        self.request.response.content_type = 'image/svg+xml'
        return {}
...
@view_config(route_name='svg.calendar', renderer='templates/calendar/calendar.jinja2')
